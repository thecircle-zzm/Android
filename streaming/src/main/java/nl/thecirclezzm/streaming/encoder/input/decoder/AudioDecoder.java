package nl.thecirclezzm.streaming.encoder.input.decoder;
...
public class AudioDecoder {
    ...
    private final LoopFileInterface loopFileInterface;
    @NonNull
    private final MediaCodec.BufferInfo audioInfo = new MediaCodec.BufferInfo();
    private final GetMicrophoneData getMicrophoneData;
    @NonNull
    private final byte[] pcmBuffer = new byte[4096];
    @NonNull
    private final byte[] pcmBufferMuted = new byte[11];
    @Nullable
    ...
    public boolean initExtractor(@NonNull String filePath) throws IOException {
        decoding = false;

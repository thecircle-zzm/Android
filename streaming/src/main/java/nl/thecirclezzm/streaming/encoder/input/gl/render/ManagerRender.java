...
import nl.thecirclezzm.streaming.encoder.input.gl.render.filters.NoFilterRender;
...
public class ManagerRender {
    ...
    @NonNull
    private final List<BaseFilterRender> baseFilterRender = new ArrayList<>(numFilters);
    @NonNull
    ...
    public void initGl(@NonNull Context context, int encoderWidth, int encoderHeight, int previewWidth,
                       int previewHeight) {

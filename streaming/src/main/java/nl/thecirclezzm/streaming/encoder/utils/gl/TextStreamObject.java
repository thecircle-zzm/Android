package nl.thecirclezzm.streaming.encoder.utils.gl;
...
public class TextStreamObject extends StreamObjectBase {
    ...
    public void load(@NonNull String text, float textSize, @ColorInt int textColor) {
        numFrames = 1;
    ...
    private Bitmap textAsBitmap(@NonNull String text, float textSize, @ColorInt int textColor) {

package nl.thecirclezzm.streaming.encoder.input.gl;
...
import nl.thecirclezzm.streaming.encoder.input.gl.render.filters.BaseObjectFilterRender;
...
public class SpriteGestureController {
    ...
    public boolean spriteTouched(@NonNull View view, @NonNull MotionEvent motionEvent) {
    ...
    public void moveSprite(@NonNull View view, @NonNull MotionEvent motionEvent) {
    ...
    public void scaleSprite(@NonNull MotionEvent motionEvent) {
        if (baseObjectFilterRender == null) return;
        if (motionEvent.getPointerCount() > 1) {

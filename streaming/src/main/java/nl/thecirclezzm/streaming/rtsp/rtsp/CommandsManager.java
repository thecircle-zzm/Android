...
import nl.thecirclezzm.streaming.rtsp.utils.AuthUtil;
...
public class CommandsManager {
    ...
    public String getResponse(BufferedReader reader, ConnectionCallbacks connectCheckerRtsp,
        ...
        try {
            ...
            if (checkStatus && getResponseStatus(response) != 200) {
                connectCheckerRtsp.onConnectionFailed("Error configure stream, " + response);
            }
            Log.i(TAG, response);
            return response;
        } catch (IOException e) {

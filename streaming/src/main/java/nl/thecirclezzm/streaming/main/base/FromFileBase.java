...
import nl.thecirclezzm.streaming.encoder.input.decoder.AudioDecoder;
import nl.thecirclezzm.streaming.encoder.input.decoder.AudioDecoderInterface;
import nl.thecirclezzm.streaming.encoder.input.decoder.LoopFileInterface;
import nl.thecirclezzm.streaming.encoder.input.decoder.VideoDecoder;
...
public abstract class FromFileBase
     ...
     */
    public boolean prepareVideo(@NonNull String filePath, int bitRate, int rotation) throws IOException {
        videoPath = filePath;
    ...
    public boolean prepareVideo(@NonNull String filePath) throws IOException {
     ...
     * @throws IOException Normally file not found.
     */
    public boolean prepareAudio(@NonNull String filePath, int bitRate) throws IOException {
        audioPath = filePath;
    ...
    public boolean prepareAudio(@NonNull String filePath) throws IOException {

...
public abstract class DisplayBase implements GetAacData, GetVideoData, GetMicrophoneData {
    ...
    @NonNull
    protected final VideoEncoder videoEncoder;
    @Nullable
    ...
    public DisplayBase(@NonNull Context context, boolean useOpengl) {
    ...
    private void startEncoders(int resultCode, @Nullable Intent data) {
        if (data == null) {

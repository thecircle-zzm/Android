...
import nl.thecirclezzm.streaming.encoder.input.video.Camera1ApiManager;
...
public abstract class Camera1Base
     ...
     */
    @RequiresApi(api = Build.VERSION_CODES.JELLY_BEAN_MR2)
    public void startRecord(@NonNull final String path, RecordController.Listener listener)
            throws IOException {

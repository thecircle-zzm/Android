...
import nl.thecirclezzm.streaming.main.base.Camera1Base;
 ...
 * {@link nl.thecirclezzm.streaming.main.base.Camera1Base}
 * <p>
...
public class RtmpCamera1 extends Camera1Base {
    ...
    public RtmpCamera1(@NonNull SurfaceView surfaceView, ConnectCheckerRtmp connectChecker) {
        super(surfaceView);
        srsFlvMuxer = new SrsFlvMuxer(connectChecker);
    }

    public RtmpCamera1(@NonNull TextureView textureView, ConnectCheckerRtmp connectChecker) {
        super(textureView);
        srsFlvMuxer = new SrsFlvMuxer(connectChecker);
    }

    @RequiresApi(api = Build.VERSION_CODES.JELLY_BEAN_MR2)
    public RtmpCamera1(@NonNull OpenGlView openGlView, ConnectCheckerRtmp connectChecker) {
        super(openGlView);
        srsFlvMuxer = new SrsFlvMuxer(connectChecker);
    }

    @RequiresApi(api = Build.VERSION_CODES.JELLY_BEAN_MR2)
    public RtmpCamera1(@NonNull LightOpenGlView lightOpenGlView, ConnectCheckerRtmp connectChecker) {

...
public class RtmpDisplay extends DisplayBase {
    ...
    public RtmpDisplay(@NonNull Context context, boolean useOpengl, ConnectCheckerRtmp connectChecker) {
